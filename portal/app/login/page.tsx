    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f5f2ec] px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#b08d57] mb-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#1e2a32] text-white py-2.5 px-4 rounded-lg text-sm font-medium hover:bg-[#24303a] disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
            >
